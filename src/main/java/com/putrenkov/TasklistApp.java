package com.putrenkov;

import com.putrenkov.controller.MemoryStatisticsController;
import com.putrenkov.controller.RootLayoutController;
import com.putrenkov.controller.TasklistController;
import com.putrenkov.model.Task;
import com.putrenkov.model.TaskListWrapper;
...
public class TasklistApp extends Application {
    ...
    public void showMemoryUsageStatistics() {
        try {
            ...
            MemoryStatisticsController controller = loader.getController();
            controller.setApplication(this);
